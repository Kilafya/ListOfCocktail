...
class CocktailListAdapter: RecyclerView.Adapter<CocktailListAdapter.CocktailViewHolder>() {
    ...
    private var cocktailList = emptyList<Drink>() // Надо изменить, чтобы presentation cлой не зависил от data
